<h2><a href="https://www.geeksforgeeks.org/problems/prime-factorization/1?page=2&category=Java&sortBy=submissions">All Prime Factors in Sorted Order</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a number <strong>n </strong>find the prime factorization of the number.</span></p>
